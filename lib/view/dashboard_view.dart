        ...
        body: Column(
          children: [
            ...
            SingleChildScrollView(
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: 96.w, vertical: 4.h),
                child: Column(
                  children: [
                    Center(
                      child: Text(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            provider.isScanning ? kColor0A9059 : kColorFC5B2D,
                      ...
                      child: Column(
                        children: [
                          !provider.isScanning
                              ...
                              : _itemBuilder('Location :', provider.location),
                          SizedBox(
                            height: 12.h,
                          ),
                          _itemBuilder(
                              ...
                              provider.lastScan == null
                                  ...
                                  : CommonFunction.getDateFromTimeStamp(
                                      provider.lastScan!, 'MM-dd-yyyy HH:mm')),
                          SizedBox(
                            height: 12.h,
                          ),
                          _itemBuilder(
                              ...
                              provider.nextScan == null
                                  ? ''
                                  : CommonFunction.getDateFromTimeStamp(
                                      provider.nextScan!, 'MM-dd-yyyy HH:mm')),
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    PrimaryButton(
                        height: 56.h,
                        width: 1.sw / 2,
                        title: provider.isScanning ? 'Stop Scan' : 'Start Scan',
                        onPressed: () async {
